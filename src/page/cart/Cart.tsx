    ...
    return (
      <div className="px-4 sm:px-8 lg:px-10 px-5 mt-10">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-8 lg:gap-24 justify-center">
                ...
                <div className="flex flex-col sm:flex-row justify-between w-full">
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-4 mt-4">
                      <button className="border px-3 py-1 bg-gray-200 rounded-lg hover:bg-gray-300 transition">
                        -
                      </button>
                  ...
                  <p className="text-lg font-semibold text-right mt-4 sm:mt-0">
                    $600
                  </p>
                </div>
              </div>
          ...
          {/* Checkout Summary */}
          <div className="w-full lg:w-1/2 bg-[#f8e6e6]  p-4 shadow-md">
            <h1 className="text-center text-sm font-medium py-2">
              You have free shipping
            </h1>
            <progress
              className="progress progress-info w-full my-4"
              value="40"
              max="100"
            ></progress>
            <div className="font-semibold">
              ...
              <div className="border border-gray-300 rounded-lg p-3 mb-6">
                <label htmlFor="MarketingAccept" className="flex items-start gap-3">
                  <input
                    type="checkbox"
                    id="MarketingAccept"
