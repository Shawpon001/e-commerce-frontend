const About = () => {
    return (
        <div className=" className=' lg:px-10 md:px-5 px-2' bg-[#f9f9f1] text-[#333] pb-12">
            <div className=" px-4">
                ...
                <div className="mt-4 flex  items-start flex-wrap">
                    <img src="https://i.ibb.co.com/2hzVSbx/Imageby-Stanislav-Kondratievvia-Unsplash.webp" className="md:w-4/4 rounded-lg shadow-lg mx-auto" alt="" />
                    <p className="text-gray-700 leading-relaxed md:text-xl">
                        Nestled in the heart of the city, The Bookistry is more than just a bookstore – it’s a sanctuary for book lovers. Our shop is designed to inspire curiosity and ignite your imagination, offering a curated collection of books from all genres. Whether you’re searching for the latest bestseller, a timeless classic, or a hidden gem, we have something for everyone. <br />
                        Step inside and you’ll be greeted by the warm glow of soft lighting and the comforting scent of books. Wooden shelves line the walls, filled with carefully selected titles. A cozy reading nook with plush armchairs invites you to sit down and lose yourself in a story. For those who enjoy a good read with a cup of coffee, our small coffee corner serves freshly brewed beverages and pastries. <br />
                        At The Bookistry, we believe in the power of stories to connect, inspire, and transform. Our mission is to create a welcoming space where readers of all ages and backgrounds can come together to explore, learn, and grow.
                        <br />
                        We’re located at <strong>2nd Floor Rifat Tower Tejgaon, Dhaka</strong>, open <strong>Saturday - Thusday : 9:00 AM - 8:00 PM</strong>. Stop by and discover your next great read. We can’t wait to welcome you to The Bookistry.
                    </p>
